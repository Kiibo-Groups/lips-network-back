            ...
            <div class="text-center card-body">
                <div class="text-success">
                    <div class="avatar avatar-sm ">
                        <span class="avatar-title rounded-circle badge-soft-success"><i class="mdi mdi-home mdi-18px"></i>
                        </span>
    ...
    <div class="col m-b-30">
        <div class="card ">
            <div class="   text-center card-body">
                ...
                <div class=" text-center">
                    <h3 style="font-size: 19px">Total de Tickets</h3>
                </div>
                <div class="text-overline ">10</div>
            </div>
        </div>
    </div>
    <div class="col m-b-30">
        <div class="card ">
            <div class="   text-center card-body">
                ...
                <div class=" text-center">
                    <h3 style="font-size: 17px">Subscripciones</h3>
                </div>
                <div class="text-overline ">3</div>
            </div>
        </div>
    </div>
    <div class="col m-b-30">
        ...
        <div class="card ">
            <div class="   text-center card-body">
                <div class="text-danger   ">
                    <div class="avatar avatar-sm ">
                        <span class="avatar-title rounded-circle badge-soft-danger"><i
                                class="mdi mdi-account mdi-18px"></i> </span>
